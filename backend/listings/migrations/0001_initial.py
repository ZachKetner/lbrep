    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(blank=True, choices=[('Inner London', 'Inner London'), ('Outter London', 'Outter London')], max_length=20, null=True)),
                ('borough', models.CharField(blank=True, max_length=50, null=True)),
                ('listing_type', models.CharField(choices=[('House', 'House'), ('Office', 'Office'), ('Apartment', 'Apartment')], max_length=20)),
